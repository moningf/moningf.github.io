---
title: 'cp、scp 与 rsync 对目录末尾 / 的处理差异'
publishDate: '2026-06-12T19:11:03+08:00'
description: '梳理 GNU/BSD cp、scp 与 rsync 在复制目录时对源路径末尾斜杠的不同处理策略。'
heroImage: { src: './feature.webp', alt: 'Linux 命令行' }
tags:
  - Linux
  - 命令行
language: '中文'
