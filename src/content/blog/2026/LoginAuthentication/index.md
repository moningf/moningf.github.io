...
publishDate: '2025-12-27T10:50:39+08:00'
description: '从 HTTP 无状态问题出发，梳理 Cookie、Session 与 JWT 的工作方式、优缺点和常见组合。'
heroImage: { src: './featured.png', alt: 'Cookie、Session 与 JWT' }
tags:
  - 笔记
  - Web
  - 身份认证
