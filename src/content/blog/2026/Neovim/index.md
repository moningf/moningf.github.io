---
title: 'Neovim 运行与配置加载机制简析'
publishDate: '2026-01-28T14:32:56+08:00'
description: '梳理 Neovim 的启动流程、Lua 模块、after 目录、插件加载机制与常用配置 API。'
heroImage: { src: './featured0.png', alt: 'Neovim 编辑器界面' }
tags:
  - Neovim
  - Linux
language: '中文'
